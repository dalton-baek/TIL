...
글 중간에 넣고싶으면 애스터리스크로 **굵은 글씨**를 넣기
...
### 자리이동 시 clone바로 하면 안됨
- 제어판의 d윈도우 자격 증명 - 일반 자격증명 -> 이전 사람으로 등록돼있기 때문에 전 사람 거를 제거하여야 함

### clone -> 새로운 환경에서 github에 있는 프로젝트를 받을 때( 프로젝트를 다시 시작할 때)
-> git clone 유알엘

### pull -> 이미 로컬에서 작업 중이고, 원격 저장소에 업데이트가 있는 경우
-> git pull origin master

---

SSAFY@DESKTOP-R2PNFNH MINGW64 ~/Desktop/first_pjt (master)
$ git init
Reinitialized existing Git repository in C:/Users/SSAFY/Desktop/first_pjt/.git/

SSAFY@DESKTOP-R2PNFNH MINGW64 ~/Desktop/first_pjt (master)
$ git remote -v
origin  https://github.com/dalton-baek/dddddd.git (fetch)
origin  https://github.com/dalton-baek/dddddd.git (push)

SSAFY@DESKTOP-R2PNFNH MINGW64 ~/Desktop/first_pjt (master)
$ git add .

SSAFY@DESKTOP-R2PNFNH MINGW64 ~/Desktop/first_pjt (master)
$ git remote add origin2 https://github.com/dalton-baek/dsdf.git
...
origin  https://github.com/dalton-baek/dddddd.git (fetch)
origin  https://github.com/dalton-baek/dddddd.git (push)
origin2 https://github.com/dalton-baek/dsdf.git (fetch)
origin2 https://github.com/dalton-baek/dsdf.git (push)
...
To https://github.com/dalton-baek/dsdf.git
...
## git 쓸 때 gui로 다뤄야 하는가 cli로 다뤄야 하는가
### *그때그ㅡ때 다르다*
### 대부분은 CLI를 쓰지만 diff, graph는 GUI를 쓴다.

## CLI의 장점 
### : Commit 명령어 1초면 끝,  GUI는 10초 걸린다.
### : 20년전 배웠으면 지금도 쓰고 있고 앞으로도 쓸것이다.
## GUI의 장점 
### : 보기편하고 친숙하고 , 기능도 다 있다.
### : diff 파일비교, graph 훨씬 보기 좋다.